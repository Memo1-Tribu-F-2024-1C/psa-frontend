...
// const ModalMostrarTicket = ({ isOpen, onClose, guardarDatos, productoId, versionId, children }: { isOpen: boolean; onClose: () => void; guardarDatos: (datos: any) => void; idProyecto: any; children: any }) => {

//   // const [datos, setDatos] = useState()
//   // const guardarDatos = (datos: any) => {
//   //     soportesAxios.post('/soporte/ticket', datos)
//   //       .then(response => {
...
//         <button
//           onClick={() => {
//             guardarDatos({ numero: numero, descripcion: descripcion, estado: estado, severidad: severidad, clienteId: 1, idProducto: productoId, idVersion: versionId });
//             onClose()
//           }}
