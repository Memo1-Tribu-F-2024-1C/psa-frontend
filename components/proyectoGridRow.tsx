...
const editarDatos = (datos: any) => {
  ...
  return (
    <tr key={`${proyecto['id']}`}>
      ...
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className=" text-m flex items-center text-gray-200">{proyecto['nombre']}</div>
      </td>
      ...
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className="text-m leading-5 text-gray-200"><FormatDate dateString={proyecto['fechaFinalizacion']} /></div>
      </td>

      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className="text-m leading-5 text-gray-200">{proyecto['estado']}</div>
      </td>
      ...
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        ...
        <button
          ...
          className="inline-flex items-center mr-3 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md">
        ...
        <button
          ...
          className="inline-flex items-center mr-3 px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white text-sm font-medium rounded-md">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
