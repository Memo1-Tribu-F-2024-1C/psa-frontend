  ...
  return (
    <tr key={`${version.codigo}`}>
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className="text-m flex justify-center items-center text-gray-200">{version.nombre}</div>
      </td>

      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className=" text-m flex justify-center items-center text-gray-200">{version.fechaCreacion}</div>
      </td>
      ...
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        ...
        <div className="flex justify-center items-center">
          ...
          <button
            ...
            className="inline-flex items-center mr-2 mt-1 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md">
          ...
          <button
            onClick={() => router.push(
              { 
                ...
                query: { version: version.codigo, producto: codigoProducto } 
              })}
