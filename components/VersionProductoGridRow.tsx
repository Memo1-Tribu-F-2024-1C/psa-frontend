...
export default function VersioProductGridRow({ version }: {  version: VersionProducto }) {
  ...
  return (
    <tr key={`${version.codigo}`}>
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className="text-m flex items-center text-gray-200">{version.codigo + 3672}</div>
      </td>
