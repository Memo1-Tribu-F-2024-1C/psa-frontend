    ...
    soportesAxios.delete(`/tickets/${ticket.numeroTicket}`)
      .then(response => {
        ...
        router.push({
          ...
          query: { version: ticket.codigoVersion} 
        });
      })
      .catch(error => {
...
const editarDatos = (datos: any) => {
  ...
  return (
    <tr key={`${ticket.numeroTicket}`}>
      ...
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className=" text-m flex justify-center items-center text-gray-200">{ticket['cuitCliente']}</div>
      </td>
      ...
      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
        <div className="flex justify-arount">
          <button
              ...
              className="inline-flex items-center mr-1.5 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-m font-medium rounded-md">
          ...
          <button
            ...
            className="inline-flex items-center mr-1.5 px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white text-sm font-medium rounded-md">
